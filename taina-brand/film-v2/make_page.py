...
page = f"""<title>Он видит больше</title>
...
<div class="wrap">
  <p class="eyebrow"><span class="dia"></span>TAINA Studio · ролик 9:16 · 0:30</p>
  ...
  <p class="note">Вертикальная версия для Reels и Shorts, собрана из ассетов TAINA Studio: Бегемот, девушка среди бумаг, логотип. Ромб, свет, бумаги и орнаменты анимированы поверх, звук синтезирован.</p>
</div>
"""
