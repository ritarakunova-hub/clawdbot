...
page = f"""<title>Он видит больше — рисованная</title>
...
<style>
  ...
  .wrap{{ max-width:560px; margin:0 auto; padding-block:40px 64px; padding-inline:20px; display:grid; gap:22px; }}
  ...
  video{{ width:100%; max-width:100%; aspect-ratio:9/16; background:#000; border:1px solid var(--line); display:block; }}
...
<div class="wrap">
  <p class="eyebrow"><span class="dia"></span>TAINA Studio · рисованный ролик 9:16 · 0:30</p>
  <h1>Он видит <em>больше.</em></h1>
  <video controls playsinline preload="auto" src="data:video/mp4;base64,{b64}"></video>
  <div class="meta">
    <span><b>0–6</b>взгляд</span><span><b>6–13</b>поиск</span><span><b>13–18</b>свет</span>
    <span><b>18–24</b>порядок</span><span><b>24–27</b>рядом</span><span><b>27–30</b>знак</span>
  </div>
  <p class="note">Полностью нарисованная версия, без фотографий: кот с контровым светом и янтарными глазами, девушка среди светящихся бумаг, арка с красным ромбом, шёлковые ленты и металлическое золото логотипа. Всё анимировано кодом, звук синтезирован.</p>
</div>
"""
